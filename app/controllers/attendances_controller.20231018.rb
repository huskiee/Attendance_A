class AttendancesController < ApplicationController
  ...
  before_action :set_one_month, only:[:edit_one_month, :edit_overwork_request, :update_one_month,:edit_monthly_request]
  ...
  private
    ...
    def daily_request_params
      params.require(:user).permit(attendances: [:daily_request_status, :daily_change, :daily_request_superior])[:attendances]
    end
